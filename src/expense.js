...
const logo_url = "http://karnaval.herokuapp.com/api/expense/logo";
for (var i = 0; i < items_number; i++) {
const date_url = "http://karnaval.herokuapp.com/api/expense/date?id=" + i;
const image_url = "http://karnaval.herokuapp.com/api/expense/image?id=" + i;
const title_url = "http://karnaval.herokuapp.com/api/expense/title?id=" + i;
