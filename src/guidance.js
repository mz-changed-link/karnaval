...
const logo_url = "http://karnaval.herokuapp.com/api/guidance/logo";
for (var i = 0; i < items_number; i++) {
const date_url = "http://karnaval.herokuapp.com/api/guidance/date?id=" + i;
const image_url = "http://karnaval.herokuapp.com/api/guidance/image?id=" + i;
const title_url = "http://karnaval.herokuapp.com/api/guidance/title?id=" + i;
